...
public class MainActivity extends BaseActivity {
    ...
    private ConversationSelectionFragment conversationSelectionFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 显示所有人消息记录的fragment
        conversationSelectionFragment = new ConversationSelectionFragment();
        chatHistoryFragment = new ChatAllHistoryFragment();
        contactListFragment = new ContactlistFragment();
        settingFragment = new SettingsFragment();
        fragments = new Fragment[] { conversationSelectionFragment,
                chatHistoryFragment, contactListFragment, settingFragment };
        // 添加显示第一个fragment
        getSupportFragmentManager().beginTransaction()
                .add(R.id.fragment_container, conversationSelectionFragment)
                .add(R.id.fragment_container, chatHistoryFragment)
                .hide(chatHistoryFragment).show(conversationSelectionFragment).commit();
    ...
    private void initView() {
        ...
        mTabs = new Button[4];
        mTabs[0] = (Button) findViewById(R.id.btn_conversation_selection);
    ...
    public void onTabClicked(View view) {
        switch (view.getId()) {
        case R.id.btn_conversation_selection:
            index = 0;
            break;
